...
* TO REVIEW :noexport:
- Check data lifecycle policy vs aws backup
- does batch fargate only use docker images or you can have custom amis?
...
*** SECURITY
- *IMPORTANT:* Cannot assign IAM rolesto a CF distribution.
...
*** Best Practices
- *IMPORTANT:* Set up a separate security account for looging, tooling, and audit-related activies.
